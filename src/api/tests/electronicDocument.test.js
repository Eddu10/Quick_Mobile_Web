...
test('/POST /electronicDocument creates a new electronic document', async (assert) => {
	...
	const actual = statusCode;
	const expected = 201;
	const message = 'POST /electronicDocument should return a status code of 201';
...
test('/POST /electronicDocument creates a new electronic document with duplicate doc_number', async (assert) => {
	...
	const actual = statusCode;
	const expected = 400;
	const message = 'POST /electronicDocument should return a status code of 400';
...
test('/GET /electronicDocument list electronic document with wrong id parameter', async (assert) => {
	...
	const actual = statusCode;
	const expected = 400;
	const message = 'GET /electronicDocument should return a status code of 400';
...
test('/GET /electronicDocument list electronic document with empty id parameter', async (assert) => {
	...
	const actual = statusCode;
	const expected = 404;
	const message = 'GET /electronicDocument should return a status code of 404';
...
test('/DELETE /electronicDocument delete an electronicDocument', async (assert) => {
	...
	const actual = statusCode;
	const expected = 200;
	const message = 'DELETE /estabelectronicDocumentlishment should return status code 200';
